  ...
  <body>
    ...
    <!-- <nav class="navbar navbar-expand-lg bg-primary">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">Bima</a>
    ...
    <div class="container">
        <form>
          <div class="mb-3">
            ...
            <input type="teks" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
          </div>
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">ASAL SMP/MTS</label>
                <input type="teks" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
